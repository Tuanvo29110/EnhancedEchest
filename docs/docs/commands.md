...
<div style="display:flex;gap:8px;flex-wrap:wrap;margin:12px 0 24px;">
  <code style="padding:4px 12px;background:var(--vp-c-brand-soft);color:var(--vp-c-brand-1);border-radius:6px;font-weight:700;">/ec</code>
...
<CommandRow commands="/ee reload" permission="ee.admin.reload">
Reload the plugin configuration and language files without restarting the server.
</CommandRow>

<CommandRow commands="/ee add &lt;player&gt; &lt;size&gt;" permission="ee.admin">
...
<CommandRow commands="/ee resize &lt;player&gt; &lt;index&gt; &lt;size&gt;" permission="ee.admin">
...
<CommandRow commands="/ee delete &lt;player&gt; &lt;index&gt;" permission="ee.admin">
...
<CommandRow :commands="['/ee migrate run &lt;player&gt;', '/ee migrate run all']" permission="ee.admin.migrate.run">
